...
<html lang="en">
  ...
  <body id="background-gradient1" onload="getCurrentDate()">
    ...
    <div class="relative w-3/4 mx-auto h-fit z-10">
      <a href="12months.php"><img src="../img/left.webp" class="absolute top-2 -left-16 h-8 w-4"/></a>
      ...
      <div class="flex flex-col w-3/4 h-fit px-12 py-5 bg-gray-50 mx-auto">
        ...
        <div class="flex justify-between w-full">
            <div class="w-1/2 text-start">
                <div class="text-sm text-gray-400">You will be saving Rp. 1.300.000,- in this purchase!</div>
                <div class="text-gray-400 mb-6 line-through">Rp. 7.899.000</div>
                <div class="">Our Price</div>
                <h1 class="text-3xl my-4">Rp. 6.599.000</h1>
        ...
        <div class="flex justify-between w-full">
            <div class="w-1/2 text-start">
                ...
                <?php
                  echo '<h3 class="text-sm font-bold">'.$_SESSION['userName'].'</h3>';
                ?>
            ...
            <div class="flex flex-col items-end w-1/2 text-end">
                    ...
                    <div class="w-full pt-12 px-8">
                        ...
                        <h2 class="text-center text-lg">12 Months Pass</h2>
                    </div>
                    <div class="flex justify-between items-end w-full pb-4 px-8">
                        ...
                        <div class="text-end">
                            <div class="text-[8px]">Bus rides for 12 months</div>
                            <div class="text-[8px]">Online transportation for 12 months</div>
                            <div class="text-[8px]">Taxis for 12 months</div>
                            <div class="text-[8px]">Train tickets for 12 months</div>
                        </div>
                    </div>
            </div>
        </div>
