...
<html lang="en">
  ...
  <body id="background-gradient1" onload="getCurrentDate()">
    ...
    <div class="relative w-3/4 mx-auto h-fit z-10">
      <a href="6months.payment.php"><img src="../img/left.webp" class="absolute top-2 -left-16 h-8 w-4"/></a>
      ...
      <div class="flex flex-col w-3/4 h-fit px-12 py-5 mx-auto">
        <div class="">
            ...
            ?>
            <div>Ticket Type: 6 Month Pass</div>
        ...
        <div class="flex flex-col items-center w-full text-end">
                    ...
                    <div class="w-full pt-16 px-12">
                        ...
                        <br />
                        <h2 class="text-center text-2xl">6 Months Pass</h2>
                    </div>
                    <div class="flex justify-between items-end w-full pb-4 px-8">
                        ...
                        <div class="text-end">
                            <div class="text-sm">Bus rides for 6 months</div>
                            <div class="text-sm">Taxis for 6 months</div>
                            <div class="text-sm">Train tickets for 6 months</div>
                        </div>
                    </div>
            </div>
        <br />
