...
<html lang="en">
    ...
    <div class="relative w-3/4 mx-auto h-fit z-10">
      ...
      <div class="flex flex-col w-3/4 h-fit px-12 py-5 bg-gray-50 mx-auto">
        <div class="">
            ...
            <div>pass type</div>
            <div class="text-4xl my-4">6 Months Pass</div>
        ...
        <div class="flex justify-between w-full">
            <div class="w-1/2 text-start">
                <div class="text-sm text-gray-400">You will be saving Rp. 900.000,- in this purchase!</div>
                <div class="text-gray-400 mb-6 line-through">Rp. 4.799.000</div>
                <div class="">Our Price</div>
                <h1 class="text-3xl my-4">Rp. 3.899.000</h1>
        ...
        <div class="flex justify-between w-full">
            <div class="w-1/2 text-start">
                ...
                <?php
                  echo '<h3 class="text-sm">'.$_SESSION['userName'].'</h3>';
                ?>
            ...
            <div class="flex flex-col items-end w-1/2 text-end">
                    ...
                    <div class="w-full pt-12 px-8">
                        ...
                        <h2 class="text-center text-lg">6 Months Pass</h2>
                    </div>
                    <div class="flex justify-between items-end w-full pb-4 px-8">
                        ...
                        <div class="text-end">
                            <div class="text-[8px]">Bus rides for 6 months</div>
                            <div class="text-[8px]">Taxis for 6 months</div>
                            <div class="text-[8px]">Train tickets for 6 months</div>
                        </div>
                    </div>
            </div>
        </div>
  ...
  <script>
    function getCurrentDate() {
        ...
        futureMonth = (currentDate.getMonth() + 1 + 6);
        if (futureMonth < 10){
