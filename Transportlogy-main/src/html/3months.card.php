    ...
    <div class="relative w-3/4 mx-auto h-fit z-10">
      ...
      <div class="flex flex-col w-3/4 h-fit px-12 py-5 mx-auto">
        <div class="">
            ...
            ?>
            <div>Ticket Type: 3 Month Pass</div>
            <div>Valid From: <span class="currentDate"></span> to <span class="futureDate"></span></div>
            <br />
            <hr />
        </div>
        <br />
        <div class="flex flex-col items-center w-full text-end">
                    ...
                    <div class="w-full pt-16 px-12">
                        ...
                        <br />
                        <h2 class="text-center text-2xl">3 Months Pass</h2>
                    </div>
                    <div class="flex justify-between items-end w-full pb-4 px-8">
                        <div class="text-start">
                            ...
                            ?>
                            <div class="text-sm"><span class="currentDate"></span> to <span class="futureDate"></span></div>
                            <div class="text-sm">*Available only across Tangerang City</div>
                        </div>
                        <div class="text-end">
                            <div class="text-sm">Bus rides for 3 months</div>
                            <div class="text-sm">Taxis for 3 months</div>
                            <div class="text-sm">Train tickets for 3 months</div>
                        </div>
                    </div>
            </div>
        <br />
